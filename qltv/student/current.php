                    ...
                    <div class="span9">
                        <form class="form-horizontal row-fluid" action="current.php" method="post">
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" id="title" name="title" placeholder="Nhập vào ID sách/tên sách." class="span8" required>
                            ...
                            ?>
                                    ...
                                    <tr>
                                      ...
                                      <td><?php echo $duedate ?></td>
                                        ...
                                        <?php 
                                         if($renewals)
                                            echo "<a href=\"renew_request.php?id=".$bookid."\" class=\"btn btn-success\">Làm mới</a>";
                                        ?>
