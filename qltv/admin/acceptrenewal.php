...
{$sql3="delete from LMS.renew where BookId='$bookid' and RollNo='$rollno'";
 ...
 $sql5="insert into LMS.message (RollNo,Msg,Date,Time) values ('$rollno','Yêu cầu làm mới: $bookid  đã được chấp nhận',curdate(),curtime())";
...
{$sql4="delete from LMS.renew where BookId='$bookid' and RollNo='$rollno'";
 ...
 $sql6="insert into LMS.message (RollNo,Msg,Date,Time) values ('$rollno','Yêu cầu làm mới: $bookid đã được chấp nhận',curdate(),curtime())";
