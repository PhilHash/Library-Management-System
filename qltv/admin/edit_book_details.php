                            ...
                            <div class="module-body">
                                ...
                                ?>
                                    ...
                                    <form class="form-horizontal row-fluid" action="edit_book_details.php?id=<?php echo $bookid ?>" method="post">
                                        ...
                                        <div class="control-group">
                                            <b>
                                            <label class="control-label" for="Publisher">Nhà sản xuất:</label></b>
                                            <div class="controls">
                                        ...
                                        <div class="control-group">
                                            <b>
                                            <label class="control-label" for="Availability">Tình trạng:</label></b>
                                            <div class="controls">
                                        ...
                                        <div class="control-group">
                                            <div class="controls">
                                                <button type="submit" name="submit"class="btn">Cập Nhật Chi Tiết</button>
                                            </div>
                                        </div>
