...
{$sql3="update LMS.book set Availability=Availability-1 where BookId='$bookid'";
 ...
 $sql5="insert into LMS.message (RollNo,Msg,Date,Time) values ('$rollno','Yêu cầu mượn: $bookid  đã được chấp nhận',curdate(),curtime())";
...
{$sql4="update LMS.book set Availability=Availability-1 where BookId='$bookid'";
 ...
 $sql6="insert into LMS.message (RollNo,Msg,Date,Time) values ('$rollno','Yêu cầu mượn: $bookid đã được chấp nhận',curdate(),curtime())";
