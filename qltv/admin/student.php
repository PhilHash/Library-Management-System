                    ...
                    <div class="span9">
                        <form class="form-horizontal row-fluid" action="student.php" method="post">
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" id="title" name="title" placeholder="Nhập vào tên hoặc số đăng ký" class="span8" required>
                                    ...
                                    <tr>
                                      ...
                                      <td><?php echo $email ?></td>                                      
                                        ...
                                        <center>
                                            ...
                                            <a href="remove_student.php?id=<?php echo $rollno; ?>" class="btn btn-danger">Xóa</a>
                                      </center>
                                        </td>
                                    </tr>
                            <?php }} ?>
