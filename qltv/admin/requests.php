        ...
        <div class="wrapper">
            <div class="container">
                <div class="row">
                    ...
                    <div class="span3">
                        <center>
                            <a href="issue_requests.php" class="btn btn-info" ><image width="100px" src="images/book2.png"></image><p>Yêu cầu mượn sách</p></a>
                        </center>
                    </div>
                    <div class="span3">
                        <center>
                            <a href="renew_requests.php" class="btn btn-info"><image width="100px" src="images/book3.png"></image><p>Yêu cầu làm mới</p></a>
                        </center>
                    </div> 
                    <div class="span3">
                        <center>
                            <a href="return_requests.php" class="btn btn-info"><image width="100px" src="images/book4.png"></image><p>Yêu cầu trả sách</p></a>
                        </center>
                    </div>
                    <!--/.span3-->
                    <!--/.span9-->
